...
The published `cli/rev@0.1.0` package reverses the bytes on each input line. It reads standard
...
records local Native/Wasm verification and published MoonX behavior.
