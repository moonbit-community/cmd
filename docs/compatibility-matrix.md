...
| `cmp` | Diffutils 3.12 | partial | Core comparison, silent/list/skip cases exist; GNU diagnostics and complete option forms need oracle coverage. | Compare all documented options and three-way statuses. |
